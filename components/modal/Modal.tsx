...
const Modal:React.FC<ModalProps> = (props:ModalProps) => {
  ...
  return <div className='fixed z-40 flex justify-center items-start top-0 left-0 bottom-0 right-0 bg-black bg-opacity-40' onClick={handleOutsideClick}  style={{padding:'12vh 16px'}}>
    <div ref={modalRef} className='relative w-full flex flex-col items-center justify-center max-w-2xl h-full bg-white rounded-lg shadow-xl transition-all z-50 transform-gpu'>
      ...
      <ModalButton theme = "Category" setModal = {props.setModal} contents = {[{korName:'웹',engName:'web',},{korName: '알고리즘', engName: 'algorhythm'},{korName: '리엑트', engName: 'React'},{korName: '자바스크립트', engName: 'javascript'}]}/>
      <ModalButton theme = 'Page' setModal = {props.setModal} contents = {[{korName:'메인',engName:'main',},{korName: '모든 포스트', engName: 'All Posts'}]}/>
      <ModalButton theme = 'preference' setModal = {props.setModal} contents = {[{korName:'다크 모드',engName:'darkmode'}]}/>
