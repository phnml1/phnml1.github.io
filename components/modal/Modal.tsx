...
const Modal:React.FC<ModalProps> = (props:ModalProps) => {
  ...
  return <div onClick={()=>{props.setModal((prev) => !prev)}} className='fixed flex justify-center items-start top-0 left-0 bottom-0 right-0 bg-black bg-opacity-40 z-50' style={{padding:'12vh 16px'}}>
    <div className='w-full flex flex-col items-center justify-center max-w-2xl h-full bg-white rounded-lg shadow-xl transition-all' style={{transform:'opacity: 0; transform: scale(0.99); pointer-events:auto'}}>
