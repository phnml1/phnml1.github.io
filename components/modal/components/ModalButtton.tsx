...
const ModalButton: React.FC<ModalButtonProps> = (props:ModalButtonProps) => {
  ...
  <div className='w-full'>
      ...
      <div key = {i} className='w-full h-auto py-4 cursor-pointer rounded-lg hover:bg-slate-200'><div className='mx-12 text-md text-black'>{a.korName}({a.engName})</div></div>
        ))
      }
      </div>);
}
