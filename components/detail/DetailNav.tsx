...
const DetailNav: React.FC<DetailNavProps> = (props) => {
  return (
    <section className="w-full flex-col flex gap-8 mt-20 mb-20 lg:flex-row lg:gap-52">
      {typeof props.prevData === 'object' && (
        <Link
          href={`${props.prevData.slug}`}
          className="w-full h-auto rounded-lg border-[1px] break-words border-detailnav cursor-pointer hover:scale-105 transition-all p-8 lg:w-[calc(50%-6.5rem)] dark:border-darkdetailnav"
        >
