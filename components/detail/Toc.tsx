  ...
  return (
    <div className="mt-12 ml-auto relative hidden lg:block">
      <div className="sticky top-32 w-60">
        <div className="p-4 rounded-t-xl border-solid border-slate-300 border-[0.5px] border-b-0 dark:border-gray-800 items-start gap-6">
          <div className="font-bold mb-2">{props.title}</div>
          <hr className='w-full border-neutral-300 dark:border-gray-800' />
        ...
        <div className='rounded-b-xl border-[0.5px] px-6 w-full h-12 border-solid bg-slate-100 dark:bg-[#363636] dark:border-gray-800  flex items-center justify-between'>
